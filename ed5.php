...
<section class="event-detail-container">
    <div class="event-detail-layout">
        ...
        <div class="event-poster-wrapper">
            <img src="assets/images/ed5.jpeg" alt="Poster Twice" class="event-poster">
        </div>
        ...
        <div class="event-info-wrapper">
            ...
            <h2 class="event-title-large">Twice - This Is For World Tour Jakarta</h2>
            
            <div class="event-meta-box">
                <p><i class="far fa-calendar-alt"></i> <strong>Tanggal:</strong> 30 juli 2029</p>
            ...
            <div class="event-description">
                ...
                <p>Bersiaplah untuk malam yang penuh energi dan rima tajam! Twice - This Is For World Tour Jakarta tahun ini membawa penampilan spesial dari Twice. Dilengkapi dengan tata panggung spektakuler, pencahayaan imersif, dan *sound system* kelas dunia yang dirancang khusus oleh PT Irama Cipta Eventa.</p>
            </div>
            ...
            <div class="action-buttons" style="margin-top: 30px;">
                <a href="beli_tiket.php?id=5" class="btn-pill" style="width: 100%; text-align: center; display: block; font-size: 16px;">Buy Tickets Now</a>
            </div>
