...
<section class="event-detail-container">
    <div class="event-detail-layout">
        ...
        <div class="event-poster-wrapper">
            <img src="assets/images/ed6.jpeg" alt="Poster NMIXX" class="event-poster">
        </div>
        ...
        <div class="event-info-wrapper">
            ...
            <h2 class="event-title-large">NMIXX: Lab Changes Up World Tour</h2>
            
            <div class="event-meta-box">
                <p><i class="far fa-calendar-alt"></i> <strong>Tanggal:</strong>22 November 2029</p>
                <p><i class="far fa-clock"></i> <strong>Waktu:</strong> 19:00 WIB - Selesai</p>
                <p><i class="fas fa-map-marker-alt"></i> <strong>Lokasi:</strong> Indonesia Arena, Jakarta</p>
            </div>

            <div class="event-description">
                <h3>About The Event</h3>
                <p>Bersiaplah untuk malam yang penuh energi dan rima tajam! NMIXX: Lab Changes Up World Tour tahun ini membawa penampilan spesial dari NMIXX. Dilengkapi dengan tata panggung spektakuler, pencahayaan imersif, dan *sound system* kelas dunia yang dirancang khusus oleh PT Irama Cipta Eventa.</p>
            </div>
            ...
            <div class="action-buttons" style="margin-top: 30px;">
                <a href="beli_tiket.php?id=6" class="btn-pill" style="width: 100%; text-align: center; display: block; font-size: 16px;">Buy Tickets Now</a>
            </div>
