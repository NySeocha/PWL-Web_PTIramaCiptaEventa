...
<section class="event-detail-container">
    <div class="event-detail-layout">
        ...
        <div class="event-poster-wrapper">
            <img src="assets/images/ed7.jpg" alt="Poster Jakarta Creative Week" class="event-poster">
        </div>
        ...
        <div class="event-info-wrapper">
            ...
            <h2 class="event-title-large">Prambanan Jazz 2027</h2>
            
            <div class="event-meta-box">
                <p><i class="far fa-calendar-alt"></i> <strong>Tanggal:</strong>01 - 05 Juli 2027</p>
                <p><i class="far fa-clock"></i> <strong>Waktu:</strong> 15:00 WIB - Selesai</p>
                <p><i class="fas fa-map-marker-alt"></i> <strong>Lokasi:</strong> Candi Prambanan, Yogyakarta</p>
            </div>

            <div class="event-description">
                <h3>About The Event</h3>
                <p>Bersiaplah untuk malam yang penuh energi dan rima tajam! Prambanan Jazz 2027 tahun ini membawa penampilan spesial dari para musisi jazz. Dilengkapi dengan tata panggung spektakuler, pencahayaan imersif, dan *sound system* kelas dunia yang dirancang khusus oleh PT Irama Cipta Eventa.</p>
            </div>
            ...
            <div class="action-buttons" style="margin-top: 30px;">
                <a href="beli_tiket.php?id=7" class="btn-pill" style="width: 100%; text-align: center; display: block; font-size: 16px;">Buy Tickets Now</a>
            </div>
