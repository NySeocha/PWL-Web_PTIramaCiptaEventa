...
<section class="event-detail-container">
    <div class="event-detail-layout">
        ...
        <div class="event-poster-wrapper">
            <img src="assets/images/ed9.jpg" alt="Lollapalooza" class="event-poster">
        </div>
        ...
        <div class="event-info-wrapper">
            ...
            <h2 class="event-title-large">Lollapalooza 2027</h2>
            
            <div class="event-meta-box">
                <p><i class="far fa-calendar-alt"></i> <strong>Tanggal:</strong>01 - 05 Desember 2027</p>
                <p><i class="far fa-clock"></i> <strong>Waktu:</strong> 11:40 WIB - Selesai</p>
                <p><i class="fas fa-map-marker-alt"></i> <strong>Lokasi:</strong> Glora Bung Karno, Jakarta</p>
            </div>

            <div class="event-description">
                <h3>About The Event</h3>
                <p>Bersiaplah untuk malam yang penuh energi dan rima tajam! Lollapalooza 2027 tahun ini membawa penampilan spesial dari para musisi jazz. Dilengkapi dengan tata panggung spektakuler, pencahayaan imersif, dan *sound system* kelas dunia yang dirancang khusus oleh PT Irama Cipta Eventa.</p>
            </div>
