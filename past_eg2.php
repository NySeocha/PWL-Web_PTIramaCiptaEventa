...
<section class="event-detail-container">
    ...
    <div class="event-detail-layout" style="margin-bottom: 50px;">
        ...
        <div class="event-poster-wrapper">
            <img src="assets/images/peg5.jpeg" alt="Poster Acara" class="event-poster" style="filter: grayscale(20%);">
        </div>
        ...
        <div class="event-info-wrapper">
            ...
            <h2 class="event-title-large">ITZY Checkmate World Tour</h2>
            
            <div class="event-meta-box" style="border-left-color: #666;">
                <p><i class="far fa-calendar-alt" style="color: #666;"></i> <strong>Tanggal:</strong> 10 Januari 2025</p>
    ...
    <div style="background: #141414; padding: 40px; border-radius: 8px; border: 1px solid #222; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div class="gallery-grid">
            <div class="gallery-item"><img src="assets/images/peg6.jpeg" alt="Keseruan Acara 1"></div>
            <div class="gallery-item"><img src="assets/images/peg7.jpg" alt="Keseruan Acara 2"></div>
            <div class="gallery-item"><img src="assets/images/peg8.jpg" alt="Keseruan Acara 3"></div>
        </div>
    </div>
