...
<section class="event-detail-container">
    ...
    <div class="event-detail-layout" style="margin-bottom: 50px;">
        ...
        <div class="event-poster-wrapper">
            <img src="assets/images/peg29.jpg" alt="Poster Acara" class="event-poster" style="filter: grayscale(20%);">
        </div>
    ...
    <div style="background: #141414; padding: 40px; border-radius: 8px; border: 1px solid #222; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div class="gallery-grid">
            <div class="gallery-item"><img src="assets/images/peg30.jpeg" alt="Keseruan Acara 1"></div>
            <div class="gallery-item"><img src="assets/images/peg31.jpeg" alt="Keseruan Acara 2"></div>
            <div class="gallery-item"><img src="assets/images/peg32.jpeg" alt="Keseruan Acara 3"></div>
        </div>
    </div>
